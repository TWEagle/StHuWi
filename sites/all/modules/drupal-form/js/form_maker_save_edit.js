function form_maker_submitbutton(pressbutton) {  already_submited = true;
  ...
  document.getElementById('show_numbers').value = document.getElementById('pages').getAttribute("show_numbers");  return true;
}
